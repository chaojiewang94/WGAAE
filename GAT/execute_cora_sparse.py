...
with tf.Graph().as_default():
    ...
    logits,hhh = model.inference(ftr_in, nb_classes, nb_nodes, is_train,
                                attn_drop, ffd_drop,
                                bias_mat=bias_in,
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(nb_epochs):
            ...
            while tr_step * batch_size < tr_size:
                ...
                _, loss_value_tr, acc_tr, h1, h2 = sess.run([train_op, loss, accuracy,logits,hhh],
                    feed_dict={
            ...
            while vl_step * batch_size < vl_size:
                ...
                loss_value_vl, acc_vl = sess.run([loss, accuracy],
                    feed_dict={
                        ...
                        msk_in: test_mask[vl_step*batch_size:(vl_step+1)*batch_size],
                        is_train: False,
